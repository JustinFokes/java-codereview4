...
public class CategoryTest {
  ...
  public void all_returnsAllInstancesOfCategory_true() {
    ...
    assertTrue(Category.getCategories().contains(firstCategory));
    assertTrue(Category.getCategories().contains(secondCategory));
  }
  @Test
  public void clear_emptiesAllCategoriesFromList_0() {
    Category testCategory = new Category("Home");
    Category.clear();
    assertEquals(Category.getCategories().size(), 0);
  }
  @Test
